...
\subsection*{Integration of Non-negative functions} 
    ...
    \begin{tbox}{\textbf{Proposition:} For $A \in \M$, the mapping $A \to \inf_A \phi\; d\mu$ is a measure on $\M$}
        \emph{Proof:} 

        The hardest part is to show that $\inf_A \phi\; d\mu$ is countably additive, that is 
