...
\section*{Oct 31}
    ...
    \tbf{Remark:} we have actually showed a stronger result: $f_{n_j} - f \to 0$ as $\mu(E_{n_j}) \to 0$. Technically, it suffices to show that they both go to $0$ -- not that it happens at the same time.
